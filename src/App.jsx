    ...
    return (
      <div className="valentine-root gifts">
        <div className="card gifts-card">
          ...
          <div className="gifts-container" style={{ display: "flex", gap: "2rem", justifyContent: "center" }}>
            <div className="gift-card" onClick={handleGift2Click}>
              <h3 className="gift-title">Gift 1</h3>
              <div className="gift-image">
                <img src={config.gifts.gift2} alt="gift 1" loading="lazy" />
              </div>
            </div>
            ...
            <div className="gift-card" onClick={handleGift3Click}>
              ...
              <div className="gift-image">
                <img src={config.gifts.gift3} alt="gift 2" loading="lazy" />
              </div>
            </div>
          </div>
